...
if __name__ == '__main__':
    gdal.AllRegister()
    dataset = gdal.Open(r"\\192.168.100.52\数据管理\影像存放路径\Raster\吉林一号\2022-04-08\JL1KF01B_PMSL3_20220408104638_200080409_101_0015_001_L3C_PSH\JL1KF01B_PMSL3_20220408104638_200080409_101_0015_001_L3C_PSH.tif")
    print('数据投影：')
